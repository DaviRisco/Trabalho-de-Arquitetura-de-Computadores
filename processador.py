...
#H <- MDR;     0b00000111000000 110101 001000001001
...
firmware[23] = 0b00001100000000010100000001000000
               #H <- MDR;
firmware[24] = 0b00000000000000110011000100000011
               #X <- X % H; GOTO MAIN;
...
firmware[27] = 0b00001110000000010100000001000000
               #H <- MDR;
               #0b00000000000001011000000100000000
firmware[28] = 0b00000000000010011000000100000000
               #X <- H >> 1; GOTO MAIN;
